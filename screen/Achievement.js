...
const achievements = [
  { name: "ปลูกเมล็ดต้นไม้แรก", current: 1, total: 1, image: require("../assets/TreeA.jpeg"),     rewards: [
    ...
    { type: "seed", name: "Common 1 เมล็ด", amount: 1,image: require("../assets/Box.png"), },
  ],},
  { name: "ปลูกต้นไม้ครบ 10 ต้น", current: 6, total: 10, image: require("../assets/TreeA.jpeg"),     rewards: [
    ...
    { type: "box", name: "กล่องสุ่มเมล็ด Uncommon", amount: 1,image: require("../assets/Box.png"), },
  ],},
  ...
  { name: "โฟกัสติดต่อกัน 1 ชั่วโมง", current: 0, total: 1, image: require("../assets/Timer.jpeg"),     rewards: [
    ...
    { type: "box", name: "เมล็ด Rare 1 เมล็ด", amount: 1 ,image: require("../assets/Box.png"),},
  ],},
  ...
  { name: "ใช้ไอเทมพิเศษเพื่อเพิ่มเหรียญจากการปลูก 5 ครั้ง", current: 5, total: 5, image: require("../assets/TreeA.jpeg"),    rewards: [
    ...
    { type: "box", name: "กล่องสุ่มเมล็ด Epic", amount: 1 ,image: require("../assets/Box.png"),},
  ], },
  { name: "ปลูกต้นไม้ระดับ Legendary", current: 0, total: 1, image: require("../assets/TreeA.jpeg"),    rewards: [
    { type: "coin", amount: 20, image: require("../assets/NatureCoins.png"), },
    { type: "box", name: "กล่องสุ่มเมล็ด Rare", amount: 1 ,image: require("../assets/Box.png"),},
  ], },
  ...
  { name: "ต้นไม้โตเต็มวัย", current: 1, total: 1, image: require("../assets/TreeA.jpeg"),     rewards: [
    { type: "coin", amount: 10, image: require("../assets/NatureCoins.png"),},
    { type: "box", name: "เมล็ด Uncommon", amount: 1 ,image: require("../assets/Box.png"),},
  ], },
  { name: "ปลูกต้นไม้ระดับ Legendary และโฟกัสติดต่อกัน 3 ชั่วโมง", current: 3, total: 3, image: require("../assets/TreeA.jpeg"),     rewards: [
    { type: "coin", amount: 30 , image: require("../assets/NatureCoins.png"),},
    { type: "box", name: "กล่องสุ่มเมล็ด Legendary", amount: 1 ,image: require("../assets/Box.png"),},
  ], },
];
